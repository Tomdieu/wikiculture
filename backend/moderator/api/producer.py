...
def publish_article_approved(event_type:str,body: Any, exchange_name: str = "moderation", exchange_type: str = "topic",
                             routing_key: str = "moderation.article.approved"):
    try:
        ...
        print("Article approval notification sent to Exchange: {}, Routing Key: {}".format(exchange_name, routing_key))
        connection.close()
