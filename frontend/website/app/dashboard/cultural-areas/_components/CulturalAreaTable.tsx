...
const CulturalAreaTable = (props: Props) => {
    ...
    if (data && data.results && culturalAreas) {
        return (
            <div className="w-full space-y-3">
                <DataTable columns={columns} data={culturalAreas} showInput={true} onChange={setSearch} />
                <CulturalAreaPagination currentPage={parseInt(page)}  culturalAreaPagination={data}/>
            </div>
        )
    }
